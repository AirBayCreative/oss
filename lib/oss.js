...
oss.prototype.authRequest = function(options,cb){
	var self = this;
	...
	if(_.is_gb2312(options[con.OSS_OBJECT])){
		options[con.OSS_OBJECT] = iconv.toEncoding(options[con.OSS_OBJECT],"utf8");
	}
			...
			function doRequest(headers,callback){
				...
				//console.log(util.inspect(req,true,null));
			      ...
			      if (typeof options['action']!="undefined" && options.dstFile) {
				    ...
				    req.pipe(wstream);
				    wstream.on('pipe',function(chunk){
...
* @return string
*/
oss.prototype.make_url = function(options){
	var url = "";
	var params = [];
...
* @return string
*/
oss.prototype.canonicalizeResource = function(options){
	var resource = '';
 ...
 * @api private
 */
oss.prototype.canonicalizeHeaders = function(headers){
	var buf = []
...
* @return string
*/
oss.prototype.get_headers = function(options,cb){
	var headers = {};
	var self = this;
...
oss.prototype.fillHeaders = function(options,headers){
...
oss.prototype.authorization = function(options,headers){
	...
	var signature = params.join('\n');
  	return 'OSS ' + this._accessId + ':' + this.hmacSha1(signature);
};
...
oss.prototype.hmacSha1 = function(signature){
...
oss.prototype.get_service = oss.prototype.list_bucket = function(callback){
	var options = {};
	options['method'] = "GET";
	options['bucket'] = '';
...
oss.prototype.create_bucket = function(options,callback){
...
oss.prototype.get_bucket = oss.prototype.list_object = function(options,callback){
	bucket_filter(options);
...
oss.prototype.delete_bucket = function(options,callback){
	bucket_filter(options);
...
oss.prototype.get_bucket_acl = function(options,callback){
	bucket_filter(options);
...
oss.prototype.set_bucket_acl = function(options,callback){
	bucket_filter(options);
...
oss.prototype.put_object = function(options,callback){
...
oss.prototype.get_object = function(options,callback){
	if(typeof options != "undefined"){
...
oss.prototype.copy_object = function(options,callback){
	bucket_filter(options);
	object_filter(options);
...
oss.prototype.head_object = function(options,callback){
	bucket_filter(options);
	object_filter(options);
...
oss.prototype.delete_object = function(options,callback){
	bucket_filter(options);
	object_filter(options);
...
oss.prototype.delete_objects = function(options,callback){
	bucket_filter(options);
...
oss.prototype.create_dir = function(options,callback){
	if(typeof options != "undefined"){
		bucket_filter(options);
	}
...
oss.prototype.get_multipart_counts = function(upload_filesize,part_size){
...
oss.prototype.initiate_multipart_upload = function(options,callback){
	bucket_filter(options);
	object_filter(options);
...
oss.prototype.upload_part = function(options,callback){
	bucket_filter(options);
	object_filter(options);
...
oss.prototype.complete_multipart_upload = function(options,callback){
	bucket_filter(options);
	object_filter(options);
...
oss.prototype.multipart_upload_object = function(options,cb){
	bucket_filter(options);
	object_filter(options);
...
oss.prototype.abort_multipart_upload = function(options,callback){
	bucket_filter(options);
	object_filter(options);
...
oss.prototype.list_multipart_uploads = function(options,callback){
	bucket_filter(options);
...
oss.prototype.list_parts = function(options,callback){
	bucket_filter(options);
	object_filter(options);
...
oss.prototype.create_object_group = function(options,callback){
	bucket_filter(options);
	object_filter(options);
...
oss.prototype.get_object_group = oss.prototype.get_object;

oss.prototype.get_object_group_index = function(options,callback){
	bucket_filter(options);
	object_filter(options);
...
oss.prototype.head_object_group = oss.prototype.head_object;

oss.prototype.delete_object_group = oss.prototype.delete_object;

/*
* other useful functions
*/

oss.prototype.upload_objects_by_dir = function(options,callback){
	if(typeof options['local'] == "undefined"){
		throw new Error("local dir is required");
	}
	var self = this;
	var path = options['local'];
	var bucket = options['bucket'];
	var ossDir = options['ossDir'];
	var _files = [];
	fs.stat(path,function(err,stats){
		if(stats.isDirectory()){
			var walker = ndir.walk(path);
